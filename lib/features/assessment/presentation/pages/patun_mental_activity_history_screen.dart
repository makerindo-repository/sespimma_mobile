...
class PatunMentalActivityHistoryScreen extends StatefulWidget {
  final List<Map<String, dynamic>> initialActivities;

  const PatunMentalActivityHistoryScreen({
    super.key,
    required this.initialActivities,
  });

  @override
  State<PatunMentalActivityHistoryScreen> createState() =>
      _PatunMentalActivityHistoryScreenState();
}

class _PatunMentalActivityHistoryScreenState
    extends State<PatunMentalActivityHistoryScreen>
  ...
  final List<String> _filters = ['Semua', 'Reward', 'Punishment'];
  ...
  Widget build(BuildContext context) {
    ...
    final filteredActivities = _selectedFilter == 'Semua'
        ...
        : dateFiltered.where((a) {
            final isReward = (a['isReward'] as bool?) ?? true;
            if (_selectedFilter == 'Reward') return isReward;
            if (_selectedFilter == 'Punishment') return !isReward;
            return true;
          }).toList();
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                ...items.map((item) {
                                  ...
                                  return _AnimatedMentalActivityTile(
                                    title:
...
class _AnimatedMentalActivityTile extends StatelessWidget {
  final String title;
  final String desc;
